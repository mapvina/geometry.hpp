...
using mapvina::feature::feature;
using mapvina::feature::feature_collection;
using mapvina::feature::null_value;
using mapvina::feature::null_value_t;
using mapvina::feature::value;
