...
void to_stream(mapvina::feature::property_map const&, std::ostream& dest);

void to_stream(std::vector<mapvina::feature::value> const&, std::ostream& dest);
...
struct value_to_stream_visitor
{
    ...
    void operator()(std::vector<mapvina::feature::value> const& vec)
    {
        out << '[';
        bool first = true;
    ...
    void operator()(std::shared_ptr<std::vector<mapvina::feature::value>> const& vec)
    {
        (*this)(*vec);
    }

    void operator()(std::unordered_map<std::string, mapvina::feature::value> const& map)
    {
        out << '{';
    ...
    void operator()(std::shared_ptr<std::unordered_map<std::string, mapvina::feature::value>> const& map)
    {
        (*this)(*map);
    }
};

inline std::ostream& operator<<(std::ostream& os, std::unordered_map<std::string, mapvina::feature::value> const& map)
{
...
inline std::ostream& operator<<(std::ostream& os, std::vector<mapvina::feature::value> const& vec)
{
    value_to_stream_visitor vis{os};
    vis(vec);
    return os;
...
inline std::ostream& operator<<(std::ostream& os, mapvina::feature::value const& val)
{
...
inline std::ostream& operator<<(std::ostream& os, mapvina::feature::identifier const& val)
{
